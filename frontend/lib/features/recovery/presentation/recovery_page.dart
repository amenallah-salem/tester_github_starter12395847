        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(child: _MetricTile(label: 'RPE', value: '7')),
                  const SizedBox(width: 12),
                  Expanded(child: _MetricTile(label: 'Sets', value: '4')),
                ],
              ),
              const SizedBox(height: 12),
              Row(
                children: [
                  Expanded(child: _MetricTile(label: 'Duration', value: '32 min')),
                  const SizedBox(width: 12),
                  Expanded(child: _MetricTile(label: 'Volume', value: '2,400 kg')),
                ],
              ),
              const SizedBox(height: 24),
